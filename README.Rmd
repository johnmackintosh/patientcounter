...
patientcounter is not on [CRAN](https://CRAN.R-project.org) yet, so install from 
...
Here is how to obtain summary data for every hour, for all combined patient stays:
